...
struct Size {
    ...
    Size(int cWidth, int cHeight) : width(cWidth), height(cWidth) {}
...
/// @param xCollision - x coordinate of collision
/// @param yCollision - y coordinate of collision
/// @param xCollisionWidth - Width of collision
/// @param yCollisionHeight - Width of collision
...
public:
    ...
    /// Allow to set new size from Size obiect
    /// \param size - Size Obiect
    void setSize(Size size);

    /// Allow to set new size from int values
    /// \param width - int
    /// \param height - int
